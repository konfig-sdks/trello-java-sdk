...
public class Boards {
  ...
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(value = "The id of the board to copy into the new board")
  ...
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(value = "The id or name of the organization to add the board to.")
  ...
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(value = "Components of the source board to copy.")
  ...
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(value = "all or a comma-separated list of: calendar, cardAging, recap or voting")
  ...
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(value = "A standard background name, or the id of a custom background")
  ...
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(value = "One of: admins or members")
  ...
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(value = "One of: org, private or public")
  ...
  **/
   ...
   * @return the Boards instance itself
   */
  public Boards putAdditionalProperty(String key, Object value) {
  ...
  * @throws IOException if the JSON Object is invalid with respect to Boards
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!Boards.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       ...
       return (TypeAdapter<T>) new TypeAdapter<Boards>() {
           ...
           public Boards read(JsonReader in) throws IOException {
             ...
             Boards instance = thisAdapter.fromJsonTree(jsonObj);
