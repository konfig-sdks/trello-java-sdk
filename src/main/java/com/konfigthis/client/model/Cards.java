...
public class Cards {
  ...
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(value = "A date, or null")
  ...
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(value = "Id of the image attachment of this card to use as its cover, or null for no cover")
  ...
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(value = "The id of the card to copy into a new card.")
  ...
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(value = "A comma-separated list of objectIds, 24-character hex strings")
  ...
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(value = "id of the list that the card should be added to")
  ...
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(value = "Properties of the card to copy over from the source.")
  ...
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(value = "all or a comma-separated list of: blue, green, orange, purple, red or yellow")
  ...
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(value = "The name of the new card.  It isn&#39;t required if the name is being copied from provided by a URL, file or card that is being copied.")
  ...
  **/
   ...
   * @return the Cards instance itself
   */
  public Cards putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.closed, cards.closed) &&
        ...
        Objects.equals(this.additionalProperties, cards.additionalProperties);
  }

  @Override
  public int hashCode() {
    return Objects.hash(closed, desc, due, fileSource, idAttachmentCover, idBoard, idCardSource, idLabels, idList, idMembers, keepFromSource, labels, name, pos, subscribed, urlSource, additionalProperties);
  }
  ...
  * @throws IOException if the JSON Object is invalid with respect to Cards
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!Cards.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       ...
       return (TypeAdapter<T>) new TypeAdapter<Cards>() {
           ...
           public Cards read(JsonReader in) throws IOException {
             ...
             Cards instance = thisAdapter.fromJsonTree(jsonObj);
